...
import proj.enterprise.ktp.exceptions.NonexistentEntityException;
import proj.enterprise.ktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("proj.enterprise_ktp_jar_0.0.1-SNAPSHOTPU");;
